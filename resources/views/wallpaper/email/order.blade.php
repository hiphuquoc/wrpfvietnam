...
<table class="sendEmail" style="font-family:'Roboto',Dosis,-apple-system,'Segoe UI',sans-serif;width:100%;background-color:#fff;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
    <tbody>
        <tr>
            <td align="center" style="font-family:'Roboto',Dosis,-apple-system,'Segoe UI',sans-serif;">
