<div class="emptyCartBox">
    <img src="{{ Storage::url('images/svg/empty-cart.png') }}" alt="{{ config('language.'.$language.'.data.your_cart_is_empty') }}" title="{{ config('language.'.$language.'.data.your_cart_is_empty') }}" />
